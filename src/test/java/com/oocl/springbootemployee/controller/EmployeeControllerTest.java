...
class EmployeeControllerTest {
    ...
    void setUp() {
        ...
        employeeJpaRepository.save(new Employee(3, "David Williams", 35, Gender.MALE, 5500.0));
        employeeJpaRepository.save(new Employee(4, "Emily Brown", 23, Gender.FEMALE, 4500.0));
        employeeJpaRepository.save(new Employee(5, "Michael Jones", 40, Gender.MALE, 7000.0));
    }

    @Test
    void should_return_employees_when_get_all_given_employee_exist() throws Exception {
        //given
        final List<Employee> givenEmployees = employeeJpaRepository.findAll();
    ...
    void should_return_employees_when_get_by_gender() throws Exception {
        // Given
        Employee femaleEmployee = employeeJpaRepository.findAll().get(1);
        Employee femaleEmployee2 = employeeJpaRepository.findAll().get(3);
...
//        assertThat(employees.get(0).getId()).isEqualTo(1);
    ...
    void should_update_employee_success() throws Exception {
        // Given
        Employee employee = employeeJpaRepository.findAll().get(0);
